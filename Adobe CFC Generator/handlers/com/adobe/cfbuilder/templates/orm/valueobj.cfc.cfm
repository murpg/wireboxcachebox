...
<cfoutput><:cfcomponent persistent="true" table="#tableinfo.getTableName()#" <cfif tableinfo.getSchema() neq ""><cfset schema="#tableinfo.getSchema()#"> schema="#trim(schema)#"</cfif> output="false">
	<!-- properties -->
	...
	<:cfproperty name="#ormField.getCFCFieldName()#" column="#ormField.getName()#" type="#ormField.getCFType()#" ormtype="#ormField.getCFCFieldType()#"<cfif #ormField.isPrimaryKey()#>fieldtype="id"</cfif>/></cfif>
	</cfloop>
